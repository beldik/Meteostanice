<?php
  ...
  $dbServer = "wm80.wedos.net"; // CZ: server, kde bezi databaze
                           // EN: server address, where DB is running

  $dbUzivatel = "a92733_pocasi";     // CZ: uzivatelske jmeno pro prihlaseni do databaze
                        // EN: username for DB

  $dbHeslo = "NodeCMU69!";    // CZ: heslo pro prihlaseni do databaze
                    // EN: password for DB

  $dbDb = "d92733_pocasi";       // CZ: nazev databaze
                    // EN: database name
  ...
  $ip = "90.179.119.220";     // CZ: IP adresa, ze ktere bude mozno pridavat hodnoty do DB kvuli ochrane
  ...
  $umisteni = "Jindřichov"; // CZ: Umisteni teplomeru (text na strance teplomeru)
  ...
  $zobrazitNastaveni = 0;  // CZ: Zda bude zobrazen radek s moznosti
